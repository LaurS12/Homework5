...
ggplot() + 
  geom_sf(data = washington_city, color = "lightgray") +
  geom_sf(data = washington, aes(color = factor(loc_homicides)), size = 1) +
  scale_fill_viridis(name = "# of homicides", option = "B", direction = -1)
```
